...
import com.snapgames.apps.desktop.game.physic.CollisionManager;
import com.snapgames.apps.desktop.game.physic.SpacePartition;
...
public class GameApp implements KeyListener, MouseListener, MouseWheelListener, MouseMotionListener {
    ...
    public static class World {
        ...
        private Rectangle2D playArea = new Rectangle2D.Double(0, 0, 640, 480);
    ...
    public static class Renderer {
        ...
        public void draw(Scene currentScene, Map<String, Object> stats) {
            ...
            if (app.isDebugAtLeast(4)) {
                ...
                app.spacePartition.draw(g, 0.8f);
            }
